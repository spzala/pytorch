...
class CrossEntropyLoss(_WeightedLoss):
    ...
    Shape:
        ...
        - Target: If containing class indices, shape :math:`()`, :math:`(N)` or :math:`(N, d_1, d_2, ..., d_K)` with
          ...
          target data type is required to be long when using class indices. If containing class probabilities, same shape
          as the input and each value should be between :math:`[0, 1]`. That means target data type is required to be float
          when using class probabilities.
